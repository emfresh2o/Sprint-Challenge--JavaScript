...
const tRex = {name: "tyrannosaure", diet: "carnivorous", weight: "7000kg", length: "12m", period: "Late Cretaceous"};
// stegoSaur, herbivorous, 2000kg, 9m, Late Jurassic
const stegosarus = {name: "stegosaurus", diet: "herbivorous", weight: "2000kg", length: "9m", period: "Late Jurassic"};
// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous
const vRaptor = {name: "velociraptor", diet: "carnivorous", weight: "15kg", length: "1.8m", period: "Late Cretaceous"};
...
for(let i=0; i<graduates.lenght; i++){
  if(graduatesw[i]["university"].includes('Uni')){
