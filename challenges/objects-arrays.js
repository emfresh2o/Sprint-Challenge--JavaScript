...
const tyrannoSaur = {name: "tyrannosaurus", diet: "carnivorous", weight: "7000kg", length: "12m", period: "Late Cretaceous"};
...
tyrannoSaur.roar = function(){
  return "RAWERSRARARWERSARARARRRR!"
}

console.log(tyrannoSaur.roar());
